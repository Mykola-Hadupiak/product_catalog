...
export const footerLinks = [
  ['https://github.com/Mykola-Hadupiak', 'Github'],
  ['https://www.linkedin.com/in/mykola-hadupiak/', 'Contacts'],
  ['https://www.linkedin.com/in/mykola-hadupiak/', 'Rights'],
];
...
export const pageCommingSoonImage = [
...
export const checkoutPageImage = [
  require('../assets/others/checkout.png'),
][0];
